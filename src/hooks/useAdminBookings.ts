    ...
    try {
      ...
      const uiBookings: UIBooking[] = data.map((b: any) => {
        ...
        return {
          ...
          hourlyDurationMinutes: b.hourlyDurationMinutes,
          includedMiles: b.includedMiles != null ? Number(b.includedMiles) : null,
          basePrice: b.basePrice != null ? Number(b.basePrice) : null,
          gratuity: b.gratuity != null ? Number(b.gratuity) : null,
